  ...
  return (
    <div className="flex min-h-screen overflow-y-auto max-w-full w-full ">
      ...
      >
        ...
        <div className=" bg-zinc-100   p-4 rounded-lg shadow-md"></div>
      ...
      <div className="flex-1 md:p-4 px-2 w-[100vw] md:w-[80vw] ">
        ...
        <div className=" mt-5 flex flex-col xl:flex-row  md:justify-between md:items-start justify-center items-center gap-7 w-full  mb-4  ">
          ...
          <div className="flex space-x-2 items-center flex-col md:flex-row gap-3 md:gap-2">
            ...
            <div className="px-2 py-2 border border-black rounded flex gap-1 items-center flex-nowrap">
              <label
                htmlFor=""
                className="bg-transp font-semibold text-sm text-nowrap"
              >
        ...
        <div className={`border     overflow-x-auto`}>
          ...
          <Modal
            className="w-fit absolute top-[30%] right-2"
            isOpen={showModal}
          ...
          <div className="flex flex-col  min-h-44  max-h-80  w-fit border hidden">
            ...
            <Modal
              ...
              className={
                "p-0 flex  border-none lg:justify-evenly justify-center  sm:ml-10 h-full items-center "
              }
            >
        ...
        <div className="flex justify-between flex-col md:flex-row gap-7 pb-10 md:pb-0 items-center mt-4">
          ...
          <div className="flex space-x-2">
            <button className="px-4 py-2 bg-zinc-200 rounded">Previous</button>
            <button className="px-4 py-2 bg-zinc-200 rounded">1</button>
            <button className="px-4 py-2 bg-zinc-200 rounded">2</button>
            <button className="px-4 py-2 bg-zinc-200 rounded">3</button>
            <button className="px-4 py-2 bg-zinc-200 rounded">Next</button>
          </div>
        </div>
      </div>
    </div>
